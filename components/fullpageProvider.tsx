...
const FullpageProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    about.current = gsap
      ...
      .set(".left .animate__this2", { y: "140%", opacity: 0 })
      .set(".left .animate__this3", { y: "140%", opacity: 0 })
      .set(".left .animate__this4", { y: "140%", opacity: 0 })
      .set(".left .animate__this5", { y: "140%", opacity: 0 })
      .set(".left .animate__this6", { y: "140%", opacity: 0 })
      .fromTo(
    ".left .animate__this1",
    {
      y: "0%",
