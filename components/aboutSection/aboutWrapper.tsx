...
export function AboutWrapper({}) {
  const [text, setText] = useState({
    main: "Featured Work",
    para: `I build the digital foundation for success. Fusing nearly a decade of full-stack expertise with deep knowledge in UX/UI and e-commerce to deliver high-converting, user-centric platforms.`,
  });
  useEffect(() => {
    if (!isDesktop()) {
      setText({
